package com.shiro.steel.aspect;
...
public class HttpAspect extends BaseApi{
    ...
    private final static Logger log = LogManager.getLogger(HttpAspect.class);

    @Pointcut("execution(public * com.shiro.steel.api..*(..))")
    public void log() {
     ...
     * @date: 2017/12/15
     */
    @Around("execution(* com.shiro.steel.api..*(..)) && args(..,bindingResult)")
